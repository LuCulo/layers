...
//canvas.add(rect);
    ...
    var imgElement = document.getElementById('cola');
        var tail = new fabric.Image(imgElement, {
          top : 190,
          left : 725,
	  originX: 'center',
	originY: 'center',
...
var AudioHandler = function() {
	...
	function update(){
		...
		debugDraw();
		tail.animate('angle',-levelsData[10]*70,{ onChange: canvas.renderAll.bind(canvas) });
	}
